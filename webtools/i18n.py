...
_TABLES = {
    "ko": {
        ...
        "Gallery": "갤러리",
        "3D Preview": "3D 미리보기",
        "bundle to preview...": "미리볼 번들...",
        "Pick a bundle to preview in 3D.": "3D로 미리볼 번들을 선택하세요.",
        "Loading 3D preview…": "3D 미리보기 불러오는 중…",
        "3D preview unavailable — showing the texture instead.": "3D 미리보기를 사용할 수 없어 텍스처를 대신 표시합니다.",
        "3D preview failed to render — showing the texture instead.": "3D 렌더링에 실패해 텍스처를 대신 표시합니다.",
        "3D preview failed to load — showing the texture instead.": "3D 미리보기를 불러오지 못해 텍스처를 대신 표시합니다.",
        "Open in 3D preview": "3D 미리보기로 열기",
    ...
    "ja": {
        ...
        "Gallery": "ギャラリー",
        "3D Preview": "3Dプレビュー",
        "bundle to preview...": "プレビューするバンドル...",
        "Pick a bundle to preview in 3D.": "3Dでプレビューするバンドルを選んでください。",
        "Loading 3D preview…": "3Dプレビューを読み込み中…",
        "3D preview unavailable — showing the texture instead.": "3Dプレビューを利用できないため、テクスチャを表示します。",
        "3D preview failed to render — showing the texture instead.": "3D描画に失敗したため、テクスチャを表示します。",
        "3D preview failed to load — showing the texture instead.": "3Dプレビューの読み込みに失敗したため、テクスチャを表示します。",
        "Open in 3D preview": "3Dプレビューで開く",
